...
public class GUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            receiverThread = new RecieverThread(client.getSocket(), this);
...
//						System.out.println("ServerBroadcast echo: " + response);
                    } catch (IOException e) {
        ...
        Platform.runLater(() -> {
            try {
                if (msg.startsWith("MOVE:")) {
                    ...
                    switch (dir) {
                        case "left":
                            iv = new ImageView(hero_left);
                            break;
                        case "right":
                            iv = new ImageView(hero_right);
                            break;
                        case "up":
                            iv = new ImageView(hero_up);
                            break;
                        case "down":
                            iv = new ImageView(hero_down);
                            break;
                        default:
                            iv = new ImageView(hero_down);
                            break;
                    ...
                    fields[x][y].setGraphic(iv);
                    scoreList.setText(getScoreList());
                }
            } catch (Exception e) {
                System.out.println("Fejl ved håndtering af besked: " + e.getMessage());
            }
        });
    }
